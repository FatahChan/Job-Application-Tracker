...
const columns = [
  ...
  columnHelper.accessor('posting', {
    header: ({ column }) => <SortableHeader column={column}>Posting</SortableHeader>,
    id: 'posting',
    cell: (cell) => {
  ...
  columnHelper.accessor('applicationDate', {
    header: ({ column }) => <SortableHeader column={column}>Application Date</SortableHeader>,
    id: 'applicationDate',
    cell: (cell) => {
  ...
  columnHelper.accessor('interviewDate', {
    header: ({ column }) => <SortableHeader column={column}>Interview Date</SortableHeader>,
    id: 'interviewDate',
    cell: (cell) => {
      let value = cell.getValue();
      if (typeof value === 'string') value = new Date(value);
  ...
  columnHelper.accessor('acceptanceDate', {
    header: ({ column }) => <SortableHeader column={column}>Acceptance Date</SortableHeader>,
    id: 'acceptanceDate',
    cell: (cell) => {
      let value = cell.getValue();
      if (typeof value === 'string') value = new Date(value);
  ...
  columnHelper.accessor('rejectionDate', {
    header: ({ column }) => <SortableHeader column={column}>Rejection Date</SortableHeader>,
    id: 'rejectionDate',
    cell: (cell) => {
      let value = cell.getValue();
      if (typeof value === 'string') value = new Date(value);
